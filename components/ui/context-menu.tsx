...
function ContextMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-[length:var(--alias-typography-caption1-font-size)] tracking-widest text-[var(--alias-color-text-subtle)] group-focus/context-menu-item:text-[var(--alias-color-text-brand)]",
        className
      )}
      {...props}
    />
