...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "peer group/switch relative inline-flex shrink-0 items-center rounded-[var(--component-switch-dimension-radius)] border border-transparent [transition:var(--alias-motion-transition-normal)] outline-none after:absolute after:-inset-x-3 after:-inset-y-[13px] data-[size=sm]:after:-inset-y-[15px] focus-visible:border-[var(--alias-color-border-active)] focus-visible:ring-3 focus-visible:ring-[var(--alias-color-border-active)]/50 aria-invalid:border-[var(--component-switch-color-track-error)] aria-invalid:ring-3 aria-invalid:ring-[var(--alias-color-feedback-error-fg)]/20 data-[size=default]:h-[18.4px] data-[size=default]:w-[32px] data-[size=sm]:h-[14px] data-[size=sm]:w-[24px] dark:aria-invalid:border-[var(--component-switch-color-track-error)]/50 dark:aria-invalid:ring-[var(--alias-color-feedback-error-fg)]/40 data-checked:bg-[var(--component-switch-color-track-checked)] data-unchecked:bg-[var(--component-switch-color-track-default)] dark:data-unchecked:bg-[var(--component-switch-color-track-default)]/80 data-disabled:cursor-not-allowed data-disabled:opacity-50",
        className
      )}
      {...props}
    >
