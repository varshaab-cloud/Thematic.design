...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-[length:var(--alias-typography-body-text1-font-size)] leading-snug font-[number:var(--alias-typography-weight-semibold)] text-[var(--component-nav-card-color-heading)] group-data-[size=sm]/card:text-[length:var(--alias-typography-body-text2-font-size)]",
        className
      )}
      {...props}
    />
...
const trendConfig = {
  up:      { icon: TrendingUp,   color: "text-[var(--alias-color-text-success)]" },
  down:    { icon: TrendingDown, color: "text-[var(--alias-color-text-error)]" },
...
function MetricCard({
  ...
  return (
    <div
      ...
      className={cn(
        "group/card flex flex-col gap-[var(--alias-spacing-stack-sm)] overflow-hidden rounded-[var(--alias-radius-xl)] py-[var(--alias-spacing-padding-md)] px-[var(--alias-spacing-padding-md)] ring-1 text-[length:var(--alias-typography-body-text2-font-size)]",
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <p className={cn(
          "text-[length:var(--alias-typography-caption1-font-size)] font-[number:var(--alias-typography-weight-medium)] uppercase tracking-wide",
        ...
        {icon && (
          <div className={cn(
            "flex items-center justify-center rounded-[var(--alias-radius-md)] p-1.5 [&_svg]:size-4",
      ...
      {/* Value */}
      <p className={cn(
        "font-[number:var(--alias-typography-weight-bold)] leading-none",
        ...
        >
          ...
          {trendValue && (
            <span aria-hidden="true" className={cn(
              "text-[length:var(--alias-typography-caption1-font-size)] font-[number:var(--alias-typography-weight-medium)]",
