...
const BASE_RESOLVE: Record<string, string> = {
  ...
  "--base-color-sky-100": "#e0f2fe",
  "--base-color-sky-200": "#bae6fd",
  "--base-color-sky-300": "#7dd3fc",
  "--base-color-sky-400": "#38bdf8",
  "--base-color-sky-500": "#0ea5e9",
  "--base-color-sky-600": "#0284c7",
  "--base-color-sky-700": "#0369a1",
  "--base-color-sky-800": "#075985",
  "--base-color-sky-900": "#0c4a6e",
  ...
  "--base-color-feedback-success-100": "#f0fdf4",
  "--base-color-feedback-success-200": "#dcfce7",
  "--base-color-feedback-success-300": "#bbf7d0",
  "--base-color-feedback-success-400": "#86efac",
  "--base-color-feedback-success-500": "#4ade80",
  "--base-color-feedback-success-600": "#16a34a",
  "--base-color-feedback-success-700": "#15803d",
  "--base-color-feedback-success-800": "#166534",
  "--base-color-feedback-success-900": "#14532d",
  "--base-color-feedback-info-100": "#f0f9ff",
  "--base-color-feedback-info-200": "#e0f2fe",
  "--base-color-feedback-info-300": "#bae6fd",
  "--base-color-feedback-info-400": "#7dd3fc",
  "--base-color-feedback-info-500": "#38bdf8",
  "--base-color-feedback-info-600": "#0284c7",
  "--base-color-feedback-info-700": "#0369a1",
  "--base-color-feedback-info-800": "#075985",
  "--base-color-feedback-info-900": "#0c4a6e",
  "--base-color-feedback-warning-100": "#fffbeb",
  "--base-color-feedback-warning-200": "#fef3c7",
  "--base-color-feedback-warning-300": "#fde68a",
  "--base-color-feedback-warning-400": "#fcd34d",
  "--base-color-feedback-warning-500": "#fbbf24",
  "--base-color-feedback-warning-600": "#d97706",
  "--base-color-feedback-warning-700": "#b45309",
  "--base-color-feedback-warning-800": "#92400e",
  "--base-color-feedback-warning-900": "#78350f",
  "--base-color-feedback-error-100": "#fff5f5",
  "--base-color-feedback-error-200": "#fee2e2",
  "--base-color-feedback-error-300": "#fecaca",
  "--base-color-feedback-error-400": "#fca5a5",
  "--base-color-feedback-error-500": "#f87171",
  "--base-color-feedback-error-600": "#dc2626",
  "--base-color-feedback-error-700": "#b91c1c",
  "--base-color-feedback-error-800": "#991b1b",
  "--base-color-feedback-error-900": "#7f1d1d",
};
...
const ALIAS_GROUPS = [
  ...
  },
  {
    ...
    tokens: [
      ...
      { name: '--alias-color-border-success',  value: 'var(--base-color-feedback-success-600)',   usage: 'Success state border',              brand: false },
      { name: '--alias-color-border-info',     value: 'var(--base-color-feedback-info-600)',      usage: 'Info state border',                 brand: false },
      { name: '--alias-color-border-warning',  value: 'var(--base-color-feedback-warning-600)',   usage: 'Warning state border',              brand: false },
      { name: '--alias-color-border-error',    value: 'var(--base-color-feedback-error-600)',     usage: 'Error state border',                brand: false },
    ],
  },
  {
    name: 'Icon',
          ...
          return (
            <div key={token} style={{
              ...
              <p style={{ fontFamily: 'monospace', fontSize: 10, color: '#aaa', margin: '0 0 1px', wordBreak: 'break-all' }}>
                → --base-color-feedback-{item.key}-{stop}
              </p>
